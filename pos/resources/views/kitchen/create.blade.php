        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white mb-0 px-0 py-2">
                    <li class="breadcrumb-item active" aria-current="page">Add Kitchen Product</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                        <div class="card-header align-items-center   border-bottom-dark px-0">
                            <div class="card-title mb-0">
                                <h3 class="card-label mb-0 font-weight-bold text-body">Add kitchen Product
                                </h3>
                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="tab-content lang-content" id="v-pills-tabContent">
                                                            <div class="tab-pane fade show active" id="home-basic"
                                                                ...
                                                                <label>Categories Kitchen</label>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <fieldset class="form-group mb-3">
                                                                    <select name="unit" class="single-select w-100 mb-3">
