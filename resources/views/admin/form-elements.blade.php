                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4">
                                                    ...
                                                    <p class="sub-header mb-4">Add class <code>custom-checkbox-outline</code> & <code>.custom-checkbox-* </code> for a color Checkboxes</p>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="custom-control custom-checkbox custom-checkbox-outline custom-checkbox-danger">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck-outlinecolor5" checked>
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="custom-control custom-radio custom-radio-info mb-3">
                                                            <input type="radio" id="customRadiocolor3" name="customRadiocolor3" class="custom-control-input" checked>
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="custom-control custom-radio custom-radio-outline custom-radio-warning mb-3">
                                                            <input type="radio" id="customRadiooutlinecolor4" name="customRadiooutlinecolor4" class="custom-control-input" checked>
