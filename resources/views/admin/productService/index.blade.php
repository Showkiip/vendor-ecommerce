                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap table-hover" id="example" cellspacing="0" width="100%" >
                                                <thead class="thead-light">
                                                    <tr>
                                                        <th scope="col">#</th>
                                                        <th scope="col">Serice image</th>
                                                        <th scope="col">Service Name</th>
                                                        <th scope="col">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @forelse ($phoneServices as $index => $phoneService)
                                                    <tr>
                                                        <td>{{$index + 1}} </td>
                                                        <td>
                                                           <img src="{{asset('storage/service/'.$phoneService->image)}}">
                                                        ...
                                                        <td>
                                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                                ...
                                                                <li class="list-inline-item px-2">
                                                                    <a href="{{url('admin/service/'.$phoneService->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="mdi mdi-account-edit-outline"></i></a>
                                                                </li>
                                                                <li class="list-inline-item px-2">
                                                                   <form action="{{url('admin/service/'.$phoneService->id)}}" method="post">
                                                                    {{csrf_field()}}
                                                                       @method('DELETE')
