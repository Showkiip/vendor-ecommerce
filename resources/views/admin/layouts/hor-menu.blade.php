                ...
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                ...
                                <a href="index" class="dropdown-item">Default</a>
                                <a href="dashboard-saas" class="dropdown-item">Saas</a>
                                <a href="dashboard-crypto" class="dropdown-item">Crypto</a>
                            </div>
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <a href="ui-image-cropper" class="dropdown-item">Image Cropper</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-crypto">
                                        <a href="crypto-wallet" class="dropdown-item">Wallet</a>
                                        <a href="crypto-buy-sell" class="dropdown-item">Buy/Sell</a>
                                        <a href="crypto-exchange" class="dropdown-item">Exchange</a>
                                        <a href="crypto-lending" class="dropdown-item">Lending</a>
                                        <a href="crypto-orders" class="dropdown-item">Orders</a>
                                        <a href="crypto-kyc-application" class="dropdown-item">KYC Application</a>
                                        <a href="crypto-ico-landing" class="dropdown-item">ICO Landing</a>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-components">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-form">
                                        ...
                                        <a href="form-layouts" class="dropdown-item">Form Layouts</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                        ...
                                        <a href="charts-tui" class="dropdown-item">Toast UI Chart</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a href="layouts-topbar-light" class="dropdown-item">Topbar Light</a>
                                <a href="layouts-boxed-hor" class="dropdown-item">Boxed Width</a>
                                <a href="layouts-colored-header" class="dropdown-item">Colored Header</a>
                            </div>
                        </li>
