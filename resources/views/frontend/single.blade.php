                ...
                <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="features-list">
                      <div class="star-rating-s15-wrapper">
                        <span class="star-rating-s15 rate-10">
                          @for($i=0;$i<5;$i++)
                            @if($product->averageRating(1)[0] > $i)
                    ...
                    <ul class="features-list">
                      <li class="price">
                        ...
                        <div class="item-price"><h3><i class="fa fa-usd"></i><span id="htmlprice">{{ $condition->price ?? '' }}</span> <span >$<del id="orig_price">{{ $condition->orig_price ?? ''}}</del></span></h3></div>
                      </li>
                    </ul>
                    <div class="features-list">
                      <!-- Color -->
                    ...
                    <ul class="features-list">
                      <li class="price">
                        ...
                        <div class="item-price" ><strong><span id="discount">{{ $discount }}</span>% discount</strong></div>
                      </li>
                      <li class="price">
...
function getPrice(price,quantity,condition,orig_price,discount)
{
