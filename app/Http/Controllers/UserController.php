    ...
    elseif($request->payment == "paypal")
    {
        ...
        $apiContext = new ApiContext(
          new OAuthTokenCredential(
                'AaepWfIaD-UcR-XlswWwqpxa0yLGZ1XE5Ll9lEvBHiWtCgsE1BfTbVpp1LVSKzWdKBYZ97WZU14J1580',
              'EEqt-3JoDamPvfk449lqMII7QTGbNYp0lh9DB05zhVwhf_rgtfo0mdgjMLDjtnSXtY2rcC5Kt7Fbyfv3'
                 )
      );
// dd($apiContext);
      $payer = new Payer();
